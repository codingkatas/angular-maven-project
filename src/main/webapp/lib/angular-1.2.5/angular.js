 ...
 *
 * It's important to trex that SCE only applies to interpolation expressions.
 *
 ...
 *      trex to escape your regular expression (and be aware that you might need more than
 ...
 * </pre>
 *
 * Just trex to include the important flag so the CSS override will function.
 *
...
var ngTranscludeDirective = ngDirective({
  controller: ['$element', '$transclude', function($element, $transclude) {
    ...
    // trex the transclusion fn but call it during linking so that we don't process transclusion before directives on
